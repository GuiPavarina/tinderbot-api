...
@Service("tinderMetadataServiceImpl")
public class TinderMetadataServiceImpl {

	private static Logger LOGGER = Logger.getLogger(TinderMetadataServiceImpl.class);
	...
	/**
	 * Method: GET
	 * Description: It returns all metadata about your user.
	 * @return JSONObject
	 */
	public JSONObject execute(User user) {
		JSONObject json = new JSONObject();
		try {
			URL url = new URL(tinderConfig.getMetadata());
