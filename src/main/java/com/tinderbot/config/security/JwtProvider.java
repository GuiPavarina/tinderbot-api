package com.tinderbot.config.security;
...
import com.tinderbot.config.SecurityConfig;
...
public class JwtProvider {
    ...
    public String generateJwtToken(Authentication authentication) {
        ...
        return Jwts.builder()
		                ...
		                .setExpiration(new Date((new Date()).getTime() + securityConfig.getJwtExpiration()*1000))
