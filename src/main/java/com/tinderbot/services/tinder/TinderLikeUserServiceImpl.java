...
@Service("tinderLikeUserServiceImpl")
public class TinderLikeUserServiceImpl {

	private static Logger LOGGER = Logger.getLogger(TinderLikeUserServiceImpl.class);
	...
	/**
	 * Method: GET
	 * Description: This method should be use to like an user by its ID.
	 * @param id
	 * @return JSONObject
	 */
	public JSONObject execute(User user,String id) {
		...
		try {
			URL url = new URL(tinderConfig.getLikeUser() + id);
