...
@Service("tinderRecommendationsServiceImpl")
public class TinderRecommendationsServiceImpl  {

	private static Logger LOGGER = Logger.getLogger(TinderRecommendationsServiceImpl.class);
	...
	/**
	 * Method: GET
	 * Description: Get a list of recommendations based on your profile.
	 * @return JSONObject
	 */
	public JSONObject execute(User user) {
		JSONObject json = new JSONObject();
		try {
			URL url = new URL(tinderConfig.getRecommendations());
